...
const { incentives } = await import('./shared/schema.js');
const { eq } = await import('drizzle-orm');

// Read the validated programs from CSV
const validatedPrograms = [
  // EPA Programs (10 programs)
  {
  ...
  // IRS Programs (32 programs - key ones)
  {
  ...
  // New York ESD Programs (6 programs)
  {
  ...
  // Department of Energy Programs (2 programs)
  {
  ...
  {
    name: "Buildings Closed Funding Opportunities",
    provider: "Department of Energy",
    level: "federal",
    amount: 0,
    status: "closed",
    deadline: null,
    description: "Various funding opportunities such as Building Envelope Innovation Prize, Lighting Prize, Home Electrification Prize, and Small Business Innovation Research awards",
    projectTypes: ["Energy Efficiency", "Advanced Technologies"],
    technology: "Energy Storage",
    url: "https://www.energy.gov/eere/buildings/buildings-closed-funding-opportunities"
  },

  // CDFI Fund Program (1 program)
  {
  ...
  // Additional high-value IRS programs
  {
