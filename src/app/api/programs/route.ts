...
const FALLBACK_PROGRAMS = [
  ...
  },
  {
    id: 'demo-6',
    external_id: 'NY-421A',
    name: 'NYC 421-a Affordable New York Housing Program',
    short_name: '421-a',
    description: 'Property tax exemption for new residential construction in NYC including affordability requirements.',
    summary: 'Up to 35-year property tax exemption for new construction with affordable units.',
    ...
    source_url: 'https://www.nyc.gov/site/hpd/services-and-information/tax-incentives-421a.page',
    application_url: 'https://www.nyc.gov/site/hpd/services-and-information/421a-tax-incentives.page',
    application_complexity: 'high',
    typical_processing_days: 180,
    stackable: true,
    eligibility_criteria: { location: 'NYC', min_affordable: 25 },
    eligibility_summary: 'Available to NYC developers providing affordable units. Requirements vary by location within the city.',
    entity_types: ['corporation', 'partnership', 'llc'],
    tier_bonuses: null,
    minimum_sustainability_tier: null,
    last_verified_at: new Date().toISOString(),
