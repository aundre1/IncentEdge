          ...
          <CardContent className="space-y-3">
            ...
            >
              ...
              <div className="flex-1">
                ...
                <p className="text-xs text-slate-500">Search {stats?.programCount ? stats.programCount.toLocaleString() : '217,000+'} incentive programs</p>
              </div>
              <ArrowRight className="h-4 w-4 text-slate-400 group-hover:text-blue-500 transition-colors" />
            </Link>
          </CardContent>
              ...
              >
                <Link href="/discover">
                  ...
                  <div className="text-left">
                    ...
                    <div className="text-xs text-slate-500">Explore {stats?.programCount ? stats.programCount.toLocaleString() : '217,000+'} incentives</div>
                  </div>
                </Link>
              </Button>
              <Button
