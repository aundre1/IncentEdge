...
const MOCK_PROGRAMS: Program[] = [
  ...
  {
    id: 'ny-affordable',
    name: 'Affordable New York Housing Program',
    agency: 'DHCR / NYC HPD',
    state: 'NY',
    type: 'Tax Credit',
    jurisdiction: 'state',
    ...
    amountMin: 500000,
    amountMax: 8000000,
    description: 'New York State program combining 421-a tax exemptions with 421-p for new multifamily construction including affordable units in NYC.',
  },
  {
    id: 'ny-htf',
  ...
  {
    id: 'nyc-421a',
    name: 'NYC 421-a Tax Exemption Program',
    agency: 'NYC HPD / DOF',
    state: 'NY',
    type: 'Tax Credit',
    jurisdiction: 'local',
    ...
    amountMax: 25000000,
    deadline: '2026-06-15',
    description: 'NYC real property tax exemption for new multifamily residential construction meeting affordability requirements. Program expiring; consult HPD for current guidance.',
  },
  {
    id: 'pg-e-rebate',
