...
export const alt = 'IncentEdge — IRA Tax Credit Discovery & Monetization Platform'
export const size = { width: 1200, height: 630 }
export const contentType = 'image/png'

const STATS = [
  { value: '$400B+', label: 'IRA Ecosystem' },
    ...
    (
      ...
      >
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
          ...
          >
            IRA Tax Credit Discovery &amp; Monetization Platform
          </div>
          <div
            style={{
              fontSize: '28px',
          ...
          >
            217,000+ programs. 60-second scan. AI-powered.
          </div>
        </div>
